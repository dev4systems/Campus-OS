  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex items-start justify-between">
        ...
        <Button size="sm"><Plus className="h-5 w-5 mr-1" /> Add Book</Button>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <div className="scroll-reveal rounded-xl border border-status-warning/20 bg-status-warning/5 p-4 text-center" style={{ transitionDelay: "140ms" }}>
      ...
      <div className="space-y-3">
        {filtered.map((book, i) => (
          <div key={book.id} className="scroll-reveal rounded-xl border border-border bg-card p-4 flex items-center justify-between" style={{ transitionDelay: `${i * 70}ms` }}>
