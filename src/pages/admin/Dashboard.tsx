    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="scroll-reveal rounded-xl border border-border bg-card p-5">
          <h2 className="text-sm font-semibold text-foreground mb-4 flex items-center gap-2"><AlertTriangle className="h-5 w-5 text-status-danger" /> Recent Complaints</h2>
        ...
        <div className="scroll-reveal rounded-xl border border-border bg-card p-5">
          <h2 className="text-sm font-semibold text-foreground mb-4 flex items-center gap-2"><Clock className="h-5 w-5 text-primary" /> Quick Actions</h2>
