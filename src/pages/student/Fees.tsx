  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-status-danger/20 bg-status-danger/5 p-4 text-center">
      ...
      <div className="space-y-3">
        {feesData.map((fee, i) => (
          <div key={i} className={`rounded-xl border p-4 flex items-center justify-between ${fee.status === "paid" ? "border-status-success/20 bg-status-success/5" : "border-status-danger/20 bg-status-danger/5"}`}>
            ...
            <div className="text-right flex items-center gap-3">
              ...
              {fee.status === "paid" ? (
                <Button variant="outline" size="sm" className="text-xs"><Download className="h-3 w-3 mr-1" /> Receipt</Button>
              ) : (
