...
const DEMO_CREDENTIALS: Record<string, { email: string; name: string }> = {
  student: { email: "arjun@nitdgp.ac.in", name: "Arjun Sharma" },
  teacher: { email: "prof.verma@nitdgp.ac.in", name: "Prof. Verma" },
  admin: { email: "admin@nitdgp.ac.in", name: "Admin" },
};
